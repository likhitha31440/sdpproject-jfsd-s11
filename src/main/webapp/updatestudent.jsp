  ...
  <c:out value="${message}"></c:out>
    ...
    <div class="form-container">
        <form method="post" action="updatestudent">
            <table>
                <% 
                    // Check if the emp object is available in the request scope
                    Student emp = (Student) request.getAttribute("emp");
                    if (emp == null) {
                        out.println("<tr><td colspan='2' style='color:red;'>Error: Student data is not available.</td></tr>");
                    } else {
                %>
                <tr>
                    <td><label for="eid">Student ID</label></td>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" id="male" name="egender" value="MALE" <%= "MALE".equals(emp.getGender()) ? "checked" : "" %> required/>
                        <label for="male">Male</label>
                        <input type="radio" id="female" name="egender" value="FEMALE" <%= "FEMALE".equals(emp.getGender()) ? "checked" : "" %> required/>
                        <label for="female">Female</label>
                        <input type="radio" id="others" name="egender" value="OTHERS" <%= "OTHERS".equals(emp.getGender()) ? "checked" : "" %> required/>
                ...
                <tr>
                    ...
                    <td>
                        <select id="edept" name="edept" required>
                            ...
                            <option value="TECHNICAL" <%= "TECHNICAL".equals(emp.getDepartment()) ? "selected" : "" %>>Technical</option>
                ...
                <tr>
                    <td><label for="egpa">Enter GPA</label></td>
                    <td><input type="number" id="egpa" name="egpa" step="0.01" value="<%= emp.getGpa() %>" required/></td>
                </tr>
                <tr>
